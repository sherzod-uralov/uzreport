...
const EducationChild = ({
  ...
  useEffect(() => {
    // Анимация левой секции с ScrollTrigger
    gsap.fromTo(
        ...
        { x: -200, opacity: 0 },
        {
          ...
          scrollTrigger: {
            ...
            start: "top 80%", // Начало анимации, когда элемент достигает 80% высоты окна
              toggleActions: "play none none reverse",
          },
        }
    );

    // Анимация правой секции с ScrollTrigger
    gsap.fromTo(
      ...
      <div className="w-full overflow-hidden flex border justify-between mb-5 max-md:flex-col max-md:justify-center pb-3">
        ...
        >
          ...
          <div className="flex max-sm:justify-center items-center mt-5">
            <button className="rounded-xl border px-4 py-1 border-[#46658B] w-[100px] h-[24px] max-md:px-0">
