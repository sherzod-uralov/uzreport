    ...
    <div className="w-full flex border justify-between mb-5 max-md:flex-col max-md:justify-center pb-3 ">
      ...
      <div className="px-20 mt-5 max-sm:px-5">
        <div className="flex items-center max-sm:justify-start">
          <Image src={money} alt="img" className="max-sm:w-[35px]"/>
          <p className="text-3xl font-semibold leading-[42px] tracking-[-1px] ml-3 text-[#042552]  max-md:text-2xl max-sm:text-xl">{price} so'm </p>
        </div>
        <div className="flex items-center mt-5 max-sm:justify-between">
          <Image src={checkImg} alt="img" className="max-sm:w-[35px]"/>
          <p className="text-[20px] font-semibold leading-[42px] tracking-[-1px] ml-3 text-[#042552]  max-md:text-[18px] max-sm:text-[15px]">20 % - {dan} 100
            % {gacha} so'm </p>
        </div>
      </div>
    </div>
