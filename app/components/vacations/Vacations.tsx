    ...
    <section className="pt-[360px] " >
        <article className="container " >
            <div className="flex justify-center items-center mt-5 ">
                <Image src={dots} alt="dots" className="left-0 absolute"/>
                <h1 className=" text-[40px] font-bold leading-[53px] tracking-[-1px] text-center">
                    {t("title")}
                </h1>
            </div>
            <div className="grid grid-cols-4 gap-[24px]">
                {[
                    ...
                    <div className="flex border border-solid border-[#EBEFF6] w-[306px] rounded-md  items-center ">
                        <div
